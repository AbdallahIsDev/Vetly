...
function applyMandatoryIdentityFields(
	...
	const firstPrimary = allFields.find((field) => field.isPrimaryName === true);
		...
		if (typedEmails.length > 1) {
			warnings.push(
				`Multiple Email fields found (${typedEmails
					.map((f) => `"${f.label}"`)
					.join(", ")}). Only the first is the required booking identity (its Required off is ignored); later Email fields use their own Required setting.`,
			);
		}
	...
	const navJustify: "flex-start" | "center" | "flex-end" | "space-between" =
		navGrouped
			...
			: isFirst
				? "flex-end"
				: "space-between";
	const terminalActionJustify: "flex-start" | "center" | "flex-end" | undefined =
		navGrouped
			? groupedNavAlignment === "left"
				? "flex-start"
				: groupedNavAlignment === "center"
	...
	if (id === "google") {
		return (
			<svg {...common} width={20} height={20} viewBox="0 0 192 192" fill="none">
				...
				<mask id="gcal-a" width="154" height="152" x="19" y="20" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }}>
					<path fill="#3c90ff" d="M19.867 49.392C17.818 33.82 29.94 20 45.645 20h100.71c15.706 0 27.827 13.82 25.778 29.392L166 96l6.133 46.608C174.182 158.18 162.061 172 146.355 172H45.645c-15.706 0-27.827-13.82-25.778-29.392L26 96z" />
				</mask>
				<g mask="url(#gcal-a)">
					<path fill="url(#gcal-b)" d="M0 0h166v76H0z" transform="matrix(1 0 0 -1 13 172)" />
				</g>
				<mask id="gcal-c" width="154" height="152" x="19" y="20" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }}>
				...
				<g mask="url(#gcal-c)">
					<path fill="url(#gcal-d)" d="M32 27.2C32 16.596 40.596 8 51.2 8h89.6c10.604 0 19.2 8.596 19.2 19.2V96H32z" filter="url(#gcal-e)" />
				</g>
				...
				<defs>
					<linearGradient id="gcal-b" x1="83" x2="83" y1="76" gradientUnits="userSpaceOnUse">
						<stop stopColor="#4fa0ff" />
						<stop offset="1" stopColor="#3186ff" />
					</linearGradient>
					<linearGradient id="gcal-d" x1="89.06" x2="89.06" y1="21.75" y2="96.39" gradientUnits="userSpaceOnUse">
						<stop stopColor="#a9a8ff" />
						<stop offset=".8" stopColor="#3c90ff" />
					</linearGradient>
					<filter id="gcal-e" width="152" height="112" x="20" y="-4" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
	...
	if (id === "office") {
		return (
			<svg {...common} width={20} height={20} viewBox="0 0 78.799 96">
				<defs>
					<linearGradient id="msof-a" gradientUnits="userSpaceOnUse" x1="16.942" x2="85.671" y1="83.36" y2="89.583">
					...
					<linearGradient id="msof-c" gradientUnits="userSpaceOnUse" x1="63.515" x2="33.003" href="#msof-b" y1="87.298" y2="84.535" />
					<linearGradient id="msof-d" gradientUnits="userSpaceOnUse" x1="44.738" x2="-5.901" y1="-3.312" y2="71.527">
					...
					<linearGradient id="msof-e" gradientUnits="userSpaceOnUse" x1="45.823" x2="35.099" href="#msof-b" y1="-4.81" y2="11.039" />
					<linearGradient id="msof-f" gradientUnits="userSpaceOnUse" x1="61.486" x2="61.486" y1="-4.887" y2="88.781">
				...
				<path d="m19.143 75.558c-2.724 0-4.945 2.121-4.945 4.753 0 1.789 1.031 3.322 2.565 4.14l19.118 10.246a10.11 10.11 0 0 0 4.969 1.303c1.164 0 2.275-.204 3.306-.562l6.531-1.814v-18.091c.027.025-31.519.025-31.545.025z" fill="url(#msof-a)" />
				<path d="m19.143 75.558c-2.724 0-4.945 2.121-4.945 4.753 0 1.789 1.031 3.322 2.565 4.14l19.118 10.246a10.11 10.11 0 0 0 4.969 1.303c1.164 0 2.275-.204 3.306-.562l6.531-1.814v-18.091c.027.025-31.519.025-31.545.025z" fill="url(#msof-c)" />
				<path d="m43.736.383a9.968 9.968 0 0 0 -2.777-.383c-1.56 0-3.12.307-4.522 1.022-.29.128-31.096 16.864-31.096 16.864-.423.205-.82.46-1.19.716-.052.025-.079.051-.132.077-.238.178-.45.357-.687.536-.106.077-.212.18-.291.256-.132.127-.265.255-.37.383-.37.383-1.005 1.2-1.005 1.2a9.15 9.15 0 0 0 -1.666 5.291v44.46c0 2.633 2.221 4.754 4.945 4.754.687 0 1.322-.128 1.904-.384l8.805-4.778c1.586-.766 2.856-2.07 3.517-3.68.158-.332.29-.74.37-1.15.026-.102.053-.23.053-.332 0-.05.026-.127.026-.178.027-.18.053-.384.053-.562 0-.154.027-.282.027-.435v-23.662-7.385c0-2.07.925-3.935 2.38-5.238 0 0-.688.613 0 0 .687-.613 1.586-1.15 2.644-1.507 1.057-.384 26.072-9.122 26.072-9.122v-14.744z" fill="url(#msof-d)" />
				<path d="m43.736.383a9.968 9.968 0 0 0 -2.777-.383c-1.56 0-3.12.307-4.522 1.022-.29.128-31.096 16.864-31.096 16.864-.423.205-.82.46-1.19.716-.052.025-.079.051-.132.077-.238.178-.45.357-.687.536-.106.077-.212.18-.291.256-.132.127-.265.255-.37.383-.37.383-1.005 1.2-1.005 1.2a9.15 9.15 0 0 0 -1.666 5.291v44.46c0 2.633 2.221 4.754 4.945 4.754.687 0 1.322-.128 1.904-.384l8.805-4.778c1.586-.766 2.856-2.07 3.517-3.68.158-.332.29-.74.37-1.15.026-.102.053-.23.053-.332 0-.05.026-.127.026-.178.027-.18.053-.384.053-.562 0-.154.027-.282.027-.435v-23.662-7.385c0-2.07.925-3.935 2.38-5.238 0 0-.688.613 0 0 .687-.613 1.586-1.15 2.644-1.507 1.057-.384 26.072-9.122 26.072-9.122v-14.744z" fill="url(#msof-e)" />
				<path d="m71.898 8.35-27.738-7.843c4.019 1.508 6.53 4.906 6.53 9.046 0 0-.025 75.2 0 77.014.027 4.088-2.67 7.589-6.53 8.892.846-.23 27.738-7.717 27.738-7.717 3.992-1.226 6.875-4.804 6.875-9.07v-61.252c.026-4.24-2.883-7.844-6.875-9.07z" fill="url(#msof-f)" />
			</svg>
		);
	}
	if (id === "outlook") {
		return (
			<svg {...common} width={20} height={20} viewBox="60 90.4 570.02 539.67">
				<defs>
					<linearGradient id="msol-a" x1="9.989" x2="30.932" y1="22.365" y2="9.375" gradientTransform="scale(15)" gradientUnits="userSpaceOnUse">
					...
					<linearGradient id="msol-b" x1="17.197" x2="28.856" y1="26.794" y2="8.126" gradientTransform="scale(15)" gradientUnits="userSpaceOnUse">
					...
					<linearGradient id="msol-c" x1="25.701" x2="12.756" y1="27.048" y2="16.501" gradientTransform="scale(15)" gradientUnits="userSpaceOnUse">
						<stop offset=".237" stopColor="#448aff" stopOpacity="0" />
						<stop offset=".792" stopColor="#0032b1" stopOpacity=".2" />
					</linearGradient>
					<linearGradient id="msol-d" x1="24.053" x2="44.51" y1="31.11" y2="18.018" gradientTransform="scale(15)" gradientUnits="userSpaceOnUse">
					...
					<linearGradient id="msol-e" x1="29.828" x2="17.397" y1="30.327" y2="19.571" gradientTransform="scale(15)" gradientUnits="userSpaceOnUse">
						<stop offset="0" stopColor="#0045b9" stopOpacity="0" />
						<stop offset=".67" stopColor="#0d1f69" stopOpacity=".2" />
					</linearGradient>
					<linearGradient id="msol-g" x1="41.998" x2="23.852" y1="29.943" y2="29.943" gradientTransform="scale(15)" gradientUnits="userSpaceOnUse">
						<stop offset="0" stopColor="#4dc4ff" stopOpacity="1" />
						<stop offset=".196" stopColor="#0fafff" stopOpacity="1" />
					</linearGradient>
					<linearGradient id="msol-k" x1="3.458" x2="20.929" y1="37.872" y2="37.86" gradientTransform="scale(15)" gradientUnits="userSpaceOnUse">
						<stop offset=".206" stopColor="#6ce0ff" stopOpacity="1" />
						<stop offset=".535" stopColor="#50d5ff" stopOpacity="0" />
					</linearGradient>
					<radialGradient id="msol-f" cx="0" cy="0" r="1" fx="0" fy="0" gradientTransform="matrix(0 -405.04051 438.393 0 360.027 102.268)" gradientUnits="userSpaceOnUse">
						<stop offset=".568" stopColor="#275ff0" stopOpacity="0" />
						<stop offset=".992" stopColor="#002177" stopOpacity="1" />
					</radialGradient>
					<radialGradient id="msol-h" cx="0" cy="0" r="1" fx="0" fy="0" gradientTransform="scale(173.58) rotate(-45 5.168 -1.292)" gradientUnits="userSpaceOnUse">
						<stop offset=".259" stopColor="#0060d1" stopOpacity=".4" />
						<stop offset=".908" stopColor="#0383f1" stopOpacity="0" />
					</radialGradient>
					<radialGradient id="msol-i" cx="0" cy="0" r="1" fx="0" fy="0" gradientTransform="matrix(357.40702 -468.44593 423.59457 323.18709 159.471 697.08)" gradientUnits="userSpaceOnUse">
						<stop offset=".732" stopColor="#f4a7f7" stopOpacity="0" />
						<stop offset="1" stopColor="#f4a7f7" stopOpacity=".501961" />
					</radialGradient>
					<radialGradient id="msol-j" cx="0" cy="0" r="1" fx="0" fy="0" gradientTransform="matrix(-170.86087 259.7254 -674.01813 -443.40415 278.562 412.979)" gradientUnits="userSpaceOnUse">
						<stop offset="0" stopColor="#49deff" stopOpacity="1" />
						<stop offset=".724" stopColor="#29c3ff" stopOpacity="1" />
					</radialGradient>
					<radialGradient id="msol-l" cx="0" cy="0" r="1" fx="0" fy="0" gradientTransform="rotate(46.924 -378.504 245.25) scale(315.927)" gradientUnits="userSpaceOnUse">
						<stop offset=".039" stopColor="#0091ff" stopOpacity="1" />
						<stop offset=".919" stopColor="#183dad" stopOpacity="1" />
					</radialGradient>
					<radialGradient id="msol-m" cx="0" cy="0" r="1" fx="0" fy="0" gradientTransform="matrix(0 168 -193.782 0 180 491.159)" gradientUnits="userSpaceOnUse">
						<stop offset=".558" stopColor="#0fa5f7" stopOpacity="0" />
						<stop offset="1" stopColor="#74c6ff" stopOpacity=".501961" />
					</radialGradient>
				</defs>
				<path d="m463.984 140.145-344.347 218.27-29.614-46.72v-40.257a43.26 43.26 0 0 1 19.72-36.293L309.91 105.258c30.496-19.79 69.777-19.793 100.277-.008Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-a)" />
				<path d="M407.102 103.34a91.293 91.293 0 0 1 3.082 1.914l156.214 101.332-387.336 245.52-59.437-93.77L403.895 177.8c26.925-17.102 28.105-55.57 3.207-74.461Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-b)" />
				<path d="M407.102 103.34a91.293 91.293 0 0 1 3.082 1.914l156.214 101.332-387.336 245.52-59.437-93.77L403.895 177.8c26.925-17.102 28.105-55.57 3.207-74.461Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-c)" />
				<path d="M333.602 498.988 179.066 452.11 507.63 243.836c27.672-17.54 27.601-57.938-.133-75.379l-1.48-.93 4.261 2.649 99.996 64.867a43.263 43.263 0 0 1 19.723 36.3v38.962Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-d)" />
				<path d="M333.602 498.988 179.066 452.11 507.63 243.836c27.672-17.54 27.601-57.938-.133-75.379l-1.48-.93 4.261 2.649 99.996 64.867a43.263 43.263 0 0 1 19.723 36.3v38.962Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-e)" />
				<path d="M410.188 105.25c-30.5-19.785-69.782-19.781-100.282.008L109.742 235.145a43.26 43.26 0 0 0-19.719 36.292v1.97a44.479 44.479 0 0 0 20.735 36.16l248.887 156.91L609.16 309.805a44.468 44.468 0 0 0 20.824-37.664v38.168l.008-38.965c0-14.66-7.426-28.32-19.722-36.301Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-f)" />
				<path d="M315.77 630.05h220.449c51.777 0 93.75-41.972 93.75-93.75V272.14c0 15.301-7.864 29.528-20.82 37.665l-327.907 205.89a60.712 60.712 0 0 0-28.422 51.414c.004 34.762 28.184 62.942 62.95 62.942Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-g)" />
				<path d="M315.77 630.05h220.449c51.777 0 93.75-41.972 93.75-93.75V272.14c0 15.301-7.864 29.528-20.82 37.665l-327.907 205.89a60.712 60.712 0 0 0-28.422 51.414c.004 34.762 28.184 62.942 62.95 62.942Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-h)" />
				<path d="M315.77 630.05h220.449c51.777 0 93.75-41.972 93.75-93.75V272.14c0 15.301-7.864 29.528-20.82 37.665l-327.907 205.89a60.712 60.712 0 0 0-28.422 51.414c.004 34.762 28.184 62.942 62.95 62.942Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-i)" />
				<path d="M405.402 630.035H183.738c-51.777 0-93.75-41.972-93.75-93.75v-264.34a44.473 44.473 0 0 0 20.754 37.621l327.582 206.52a61.737 61.737 0 0 1 28.809 52.226c-.004 34.09-27.64 61.723-61.73 61.723Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-j)" />
				<path d="M405.402 630.035H183.738c-51.777 0-93.75-41.972-93.75-93.75v-264.34a44.473 44.473 0 0 0 20.754 37.621l327.582 206.52a61.737 61.737 0 0 1 28.809 52.226c-.004 34.09-27.64 61.723-61.73 61.723Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-k)" />
				<path d="M108.75 345h142.5c26.926 0 48.75 21.824 48.75 48.75v142.5c0 26.926-21.824 48.75-48.75 48.75h-142.5C81.824 585 60 563.176 60 536.25v-142.5C60 366.824 81.824 345 108.75 345Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-l)" />
				<path d="M108.75 345h142.5c26.926 0 48.75 21.824 48.75 48.75v142.5c0 26.926-21.824 48.75-48.75 48.75h-142.5C81.824 585 60 563.176 60 536.25v-142.5C60 366.824 81.824 345 108.75 345Zm0 0" stroke="none" fillRule="nonzero" fill="url(#msol-m)" />
				<path d="M179.387 534c-19.848 0-36.137-6.21-48.875-18.625-12.739-12.414-19.11-28.617-19.11-48.605 0-21.11 6.465-38.18 19.395-51.22C143.73 402.517 160.66 396 181.594 396c19.781 0 35.879 6.238 48.297 18.715 12.484 12.476 18.726 28.93 18.726 49.351 0 20.985-6.469 37.899-19.398 50.75C216.352 527.606 199.742 534 179.387 534Zm.574-26.352c10.816 0 19.523-3.695 26.117-11.082 6.594-7.386 9.89-17.664 9.89-30.824 0-13.719-3.202-24.394-9.6-32.031-6.403-7.637-14.95-11.453-25.638-11.453-11.011 0-19.878 3.941-26.597 11.824-6.723 7.824-10.082 18.191-10.082 31.102 0 13.101 3.36 23.468 10.082 31.101 6.719 7.574 15.328 11.363 25.828 11.363Zm0 0" stroke="none" fillRule="nonzero" fill="#fff" fillOpacity={1} />
				<path d="M179.332 535.848c-19.77 0-36-6.375-48.691-19.13-12.688-12.753-19.036-29.398-19.036-49.929 0-21.684 6.442-39.219 19.325-52.61 12.882-13.394 29.75-20.09 50.601-20.09 19.703 0 35.742 6.411 48.114 19.227 12.437 12.82 18.652 29.72 18.652 50.7 0 21.55-6.442 38.93-19.32 52.129-12.82 13.136-29.368 19.703-49.645 19.703Zm.57-27.067c10.778 0 19.453-3.797 26.02-11.383 6.57-7.59 9.851-18.144 9.851-31.664 0-14.093-3.187-25.058-9.562-32.902-6.379-7.844-14.89-11.766-25.54-11.766-10.972 0-19.804 4.047-26.5 12.149-6.694 8.031-10.042 18.683-10.042 31.945 0 13.457 3.348 24.106 10.043 31.95 6.695 7.78 15.273 11.671 25.73 11.671Zm0 0" stroke="none" fillRule="nonzero" fill="#fff" fillOpacity={1} />
			</svg>
		);
	}
	if (id === "manage") {
...
function makeFieldObjectControls() {
	return {
		...
		required: {
			...
			defaultValue: false,
			hidden: (p: FieldControlProps) =>
				// BE-039/BE-046: flagged names are always required — no toggle.
